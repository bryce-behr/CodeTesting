...
public class ComputerGuessesPanel extends JPanel {
    ...
    public ComputerGuessesPanel(JPanel cardsPanel, Consumer<GameResult> gameFinishedCallback){
        ...
        lowerBtn.addActionListener(e -> {
            guessMessage.setText("I guess " + ai.nextGuess(false) + ".");
        });
        this.add(lowerBtn);
        ...
        correctBtn.addActionListener(e -> {
            ...
            GameResult result = new GameResult(false, ai.getLastGuess(), ai.getNumGuesses());
        ...
        higherBtn.addActionListener(e -> {
            guessMessage.setText("I guess " + ai.nextGuess(true) + ".");
        });
        this.add(higherBtn);
        ...
        this.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent e) {
                ...
                guessMessage.setText("I guess " + ai.getLastGuess() + ".");
            }
        });
    }
}
